...
V43_STATE = Path(os.environ.get("DENOISENET_V43_STATE", ROOT / "results/rgcc_v43/state"))
V44_RESULT = Path(os.environ.get("DENOISENET_V44_RESULTS", ROOT / "results/rgcc_eog_v44"))
BANKED = ROOT / "results"
SUPPORT_STOP = 12000
QGEN = (15000, 27000)
NATURAL_START = 30000
