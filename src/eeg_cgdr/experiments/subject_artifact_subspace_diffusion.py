...
def _technical(config: Mapping[str, Any], run_dir: Path) -> Mapping[str, Any]:
    ...
    for step in range(200):
        ...
        if initial is None: initial = float(loss)
