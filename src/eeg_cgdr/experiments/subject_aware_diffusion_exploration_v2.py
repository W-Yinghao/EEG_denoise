...
def _j4_rank(config: Mapping[str, Any], run_dir: Path) -> Mapping[str, Any]:
    ...
    for route in candidates:
        ...
        pop_rrmse = _mean_metric(klados, "POP", "clean_waveform_RRMSE")
        det_rrmse = _mean_metric(klados, det, "clean_waveform_RRMSE")
