...
def _fidelity(method,generated,target,training_artifact,participant,seed):
    ...
    # Exposure is measured against the source-training bank, never validation targets.
