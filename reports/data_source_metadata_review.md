...
> **后续范围修订（2026-08-01）：** 本文保留网络审查当时的证据边界；
> 其中要求全根目录盘点、本地逐文件哈希和等待全盘结果才下载的
> 行政要求，已被用户后续指定的私人项目轻量流程取代。当前访问、
> 路径和样本可读性以 `reports/data_inventory/summary.md` 与
> `datasets/registry/` 为准。
