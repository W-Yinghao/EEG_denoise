...
| MobileBCI | Official OSF R7S9B acquisition completed at `/projects/EEG-foundation-model/mobile_bci`: 2,973 files, 9,125,232,937 declared bytes | Header-only audit found 24 participants and 198 record headers. The processed BIDS EEG table has 46 EEG plus 27 IMU channels and omits EOG; official `sourcedata` retains 46 EEG plus four EOG, with IMU stored separately. | Development split frozen without opening outcomes: sub-01--16 training-development, sub-17--24 heldout-development; ses-02 standing support to ses-03/04/05 locomotion query; 47 eligible participant-task pairs |
